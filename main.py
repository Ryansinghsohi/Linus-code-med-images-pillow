...
# these are the items in the game that have pictures
items = {"RagePotion": "Rage.jpg",
         "HealingPotion": "Healing.jpg",
         "LesserHealingPotion": "LesserHealing.png",
         "Stick": "Stick.png",
         "Sword": "Sword.png",
         "BrokenWeapon": "BrokenWeapon.jpg"}


# this is a function that takes the name of an items and checks if it is in the dikt and then show the photo
def check_items(item_name):
    if item_name in items:  # checks if the item name is in the dikt
        item_img = Image.open(items[item_name])  # makes a variable for the items image
        return item_img.show()  # shows the photo of the item // prints the photo
    else:  # if the items name is not in the dikt
        print('not in list')
...
class Player(Fighter):
    ...
    def break_weapon(self, weapon):
        if self.weapon_broken(weapon):
            ...
            check_items("BrokenWeapon")     # show broken weopen
    ...
    def equip_weapon(self, weapon):
        ...
        check_items(weapon)     # show the equited weapon
    ...
    def add_consumable(self, food):
        ...
        check_items(food)       # show consumable
